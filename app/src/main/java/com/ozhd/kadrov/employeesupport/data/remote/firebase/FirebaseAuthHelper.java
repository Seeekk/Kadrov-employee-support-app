...
/**
 * Обёртка над Firebase Auth: безопасные вызовы при отсутствии google-services / инициализации.
 */
public final class FirebaseAuthHelper {
    ...
    /** Не блокирует UI; при ошибке Firebase просто не выполняется вход в Firebase Auth. */
